...
Router.route('/talk/:id', function () {
  ...
  this.layout('default');
  this.render('talk', {data:videos.findOne({"_id": oid})});
});
...
Router.route('/talk/edit/:id', function () {
  ...
  var oid = new Meteor.Collection.ObjectID(this.params.id);
  this.layout('default');
  this.render('editTalk',{data:videos.findOne({"_id": oid})});
});

Router.route('/talk/tag/:id', function () {
  Meteor.subscribe('videos', function onReady() {
    Session.set('videosLoaded', true);
  });
  var oid = new Meteor.Collection.ObjectID(this.params.id);
  this.layout('default');
  this.render('tagTalk', {data:videos.findOne({"_id": oid})});
